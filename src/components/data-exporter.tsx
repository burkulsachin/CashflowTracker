...
export function DataExporter() {
  const { transactions, categories, budgets, goals, user, importData } =
    useStore();
  ...
  const handleExportCsv = () => {
    ...
    downloadFile(
      headers + rows,
      `cashflow-transactions-${new Date().toISOString().split('T')[0]}.csv`,
      'text/csv'
    );
    toast({
      title: 'CSV Exported',
  ...
  const handleExportJson = () => {
    ...
    downloadFile(
      jsonString,
      `cashflow-backup-${new Date().toISOString()}.json`,
      'application/json'
    );
    toast({
      title: 'Backup Exported',
      description: 'Your full data backup has been downloaded.',
    });
  };
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download your data in different formats for safekeeping or use in
            other applications.
          </CardDescription>
        </CardHeader>
          ...
          <CardDescription className="flex items-start gap-2">
            ...
            <span>
              ...
              <b className="text-destructive">
                {' '}
                completely overwrite all your current data
              </b>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              with the data from{' '}
              <b>{restoreFile?.name}</b>. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
